(() => {
  ...
  e.mousePrlx = new (class {
    ...
    setLogging(e) {
      this.config.logging && t(`[PRLX Mouse]: ${e}`);
    }
  })({});
  e.watcher = new (class {
    constructor(e) {
    ...
    scrollWatcherLogging(e) {
      this.config.logging && t(`[Наблюдатель]: ${e}`);
    }
    ...
    (o = function (e, t) {
          ...
          function (e, t) {
            w.fn[e] = function (n, r) {
              ...
              return (
                ...
                1 < this.length &&
                  (H[e] || w.uniqueSort(i), q.test(e) && i.reverse()),
                this.pushStack(i)
              );
            };
          }
            ...
            var n = [
              ...
              i = {
                ...
                then: function (t, r, i) {
                  ...
                  return w
                    .Deferred(function (e) {
                      n[0][3].add(a(0, e, h(i) ? i : W, e.notifyWith)),
                        n[1][3].add(a(0, e, h(t) ? t : W)),
        ...
        special: {
          ...
          click: {
            ...
            trigger: function (e) {
              var t = this || e;
              return (
                de.test(t.type) && t.click && k(t, "input") && Ee(t, "click"),
                !0
              );
            },
            _default: function (e) {
      ...
      function He(e, t, n, r) {
        ...
        var i,
          ...
          v = t[0],
          m = h(v);
        if (m || (1 < d && "string" == typeof v && !p.checkClone && ke.test(v)))
        ...
        if (
          ...
          for (u = (s = w.map(ve(i, "script"), De)).length; f < d; f++)
            (l = i),
              f !== g &&
      ...
      w.extend(w.event, {
        trigger: function (t, n, r, i) {
          ...
          if (
            ...
            if (!i && !d.noBubble && !g(r)) {
              for (
                u = d.delegateType || y, yt.test(u + y) || (a = a.parentNode);
                a;
                a = a.parentNode
              )
                m.push(a), (s = a);
      ...
      (Pt.href = bt.href),
        w.extend({
          ...
          ajax: function (t, n) {
            ...
            if (p.beforeSend && (!1 === p.beforeSend.call(h, A, p) || l))
              return A.abort();
            if (
              ((C = "abort"),
              y.add(p.complete),
              ...
              if (((A.readyState = 1), c && g.trigger("ajaxSend", [A, p]), l))
                return A;
              p.async &&
                0 < p.timeout &&
            ...
            function E(t, n, a, u) {
              ...
              l ||
                ...
                f
                  ? (p.ifModified &&
                      ((T = A.getResponseHeader("Last-Modified")) &&
                        (w.lastModified[i] = T),
                      (T = A.getResponseHeader("etag")) && (w.etag[i] = T)),
                    204 === t || "HEAD" === p.type
                      ? (C = "nocontent")
                      : 304 === t
                      ? (C = "notmodified")
                      : ((C = b.state), (d = b.data), (f = !(v = b.error))))
                  : ((v = C), (!t && C) || ((C = "error"), t < 0 && (t = 0))),
                (A.status = t),
                (A.statusText = (n || C) + ""),
                f ? m.resolveWith(h, [d, C, A]) : m.rejectWith(h, [A, C, v]),
                A.statusCode(x),
                (x = void 0),
                c &&
                  g.trigger(f ? "ajaxSuccess" : "ajaxError", [A, p, f ? d : v]),
                y.fireWith(h, [A, C]),
                c &&
      ...
      w.ajaxSetup({
        ...
        w.each(["top", "left"], function (e, t) {
          w.cssHooks[t] = $e(p.pixelPosition, function (e, n) {
            if (n)
              return (n = Me(e, t)), Re.test(n) ? w(e).position()[t] + "px" : n;
          });
        }),
      ...
      return (
        (w.noConflict = function (t) {
          return (
            e.$ === w && (e.$ = Yt), t && e.jQuery === w && (e.jQuery = Vt), w
          );
        }),
